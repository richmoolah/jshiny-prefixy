...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT redis++::redis++_static #############
        ...
        set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${redis-plus-plus_redis++_redis++_static_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${redis-plus-plus_redis++_redis++_static_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${redis-plus-plus_redis++_redis++_static_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${redis-plus-plus_redis++_redis++_static_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${redis-plus-plus_redis++_redis++_static_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET redis++::redis++_static PROPERTY INTERFACE_LINK_LIBRARIES redis++::redis++_static APPEND)
